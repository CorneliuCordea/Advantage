...
public class EntityMapper {
	...
	public static final String MATCH_TYPE = "match_type";/* competition/friendly */
	public static final String MATCH_SCORING_TYPE = "scoring_type";/*2/3,2/3TB*/
	public static final String MATCH_TIME = "match_time";/* YYYY.MM.DD */
	public static final String MATCH_INDOOR = "indoor";/* true,false */
	public static final String MATCH_OPPONENT_NAME = "opponent_name";/*	 */
	public static final String MATCH_OPPONENT_TP_RATING = "opponent_tp_rating";/*	 */
	public static final String MATCH_PEBBLE_USER_NAME = "pebble_user_name";/*	 */
	public static final String MATCH_PEBBLE_USER_TP_RATING = "pebble_user_tp_rating";/*	 */
	public static final String MATCH_COMMENTS = "match_comments";/*	 */
	
	public static final String POINT_ENTITY_NAME = "point";/*	 */
	public static final String POINT_HAND_SIDE = "hand_side";/*FH/BH	 */
	public static final String POINT_PEBBLE_USER_SERVING = "pebbleuser_serving";/*true/false	 */
	public static final String POINT_INDEX = "index";/*1..n	 */
	public static final String POINT_UNFORCED = "unforced";/*active+/active-/passive	 */
	public static final String POINT_ACE = "ace";/*true/false	 */
	public static final String POINT_DOUBLE_FAULT = "double_fault";/*true/false	 */
	public static final String POINT_FIRST_SERVE = "first_serve";/*true/false	 */
	public static final String POINT_FORCED = "forced";/*true/false	 */
	public static final String POINT_AT_NET = "at_net";/*true/false	 */
	public static final String POINT_WINNER = "winner";/*true/false	 */
	public static final String POINT_PEBBLEUSER_WON = "pebbleuser_won";/*true/false	 */
	...
	public static Entity matchToEntity(Match match) {
		...
		try {
			matchEntity.setProperty(MATCH_TIME, df.parse(match.getMatchTime()));
	...
	public static Match entityToMatch(Entity matchEntity) {
		...
		match.setOpponentTpRating(((Long) matchEntity.getProperty(MATCH_OPPONENT_TP_RATING)).intValue());
		match.setPebbleUser((String) matchEntity.getProperty(MATCH_PEBBLE_USER_NAME));
		match.setPebbleUserTpRating(((Long) matchEntity.getProperty(MATCH_PEBBLE_USER_TP_RATING)).intValue());
		match.setScoringType((String) matchEntity.getProperty(MATCH_SCORING_TYPE));
		
		String matchTime = df.format((Date) matchEntity.getProperty(MATCH_TIME));
		
		match.setMatchTime(matchTime);
		match.setIndoor((boolean) matchEntity.getProperty(MATCH_INDOOR));
		match.setMatchUUID(matchEntity.getKey().getName());
		return match;
	}
